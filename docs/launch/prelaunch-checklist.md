...
## 一、阻断项：已修复（TASK-0169，随 v0.4.1 发布）
...
1. ~~修 B1 到 B3，加进演示和 CI；验证 TASK-0169 后发 v0.4.1~~（已完成，2026-09-26）。
2. ~~把 README「接到你自己的项目」里的版本号从 `@v0.4.0` 改成 `@v0.4.1`~~（已完成；F6 完成后再改成 `pip install sopcontrol`）。
